...
export const LabTechLayout = () => {
  ...
  const menuItems = [
    { name: "Dashboard", path: "/lab-tech/dashboard", icon: "🔬" },
    { name: "Test Queue", path: "/lab-tech/queue", icon: "📋" },
    { name: "Upload Reports", path: "/lab-tech/reports", icon: "📤" },
    { name: "Completed Tests", path: "/lab-tech/completed", icon: "✅" },
  ]
