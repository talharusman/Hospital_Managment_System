...
export const PatientLayout = () => {
  ...
  const menuItems = [
    ...
    { name: "Book Appointment", path: "/patient/book-appointment", icon: CalendarDays },
    ...
    { name: "Invoices", path: "/patient/invoices", icon: Receipt },
  ]
            ...
            >
              ...
              {sidebarOpen && (
                <div className="leading-tight">
                  <p className="text-sm font-semibold tracking-wide">Patient Portal</p>
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-border bg-card px-3 py-2 shadow-sm">
                <div className="hidden text-right leading-tight sm:flex sm:flex-col sm:items-end">
                  ...
                  <p className="text-xs capitalize text-muted-foreground">{user?.role ?? "patient"}</p>
                </div>
                <div
                ...
                >
                  {userInitial || <HeartPulse className="h-4 w-4" />}
                </div>
                <button
