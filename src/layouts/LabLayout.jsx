...
export const LabLayout = () => {
  ...
  const menuItems = [
    ...
    { name: "Test Requests", path: "/lab/tests", icon: "🔬" },
    { name: "Upload Reports", path: "/lab/upload-reports", icon: "📤" },
    { name: "Completed Reports", path: "/lab/completed", icon: "✅" },
    { name: "Patients", path: "/lab/patients", icon: "👥" },
  ]
