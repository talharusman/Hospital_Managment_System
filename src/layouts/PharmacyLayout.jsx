...
export const PharmacyLayout = () => {
  ...
  const brandTaglineStyle = { opacity: 0.75 }
  ...
  const menuItems = [
    { name: "Dashboard", path: "/pharmacy/dashboard", icon: LayoutGrid },
            ...
            >
              ...
              {sidebarOpen && (
                <div className="leading-tight">
                  <p className="text-sm font-semibold tracking-wide">Smart Pharmacy</p>
                  <p className="text-xs" style={brandTaglineStyle}>
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-border bg-card px-3 py-2 shadow-sm">
                <div className="hidden text-right leading-tight sm:flex sm:flex-col sm:items-end">
                  <p className="text-sm font-semibold text-foreground">{user?.name ?? "Pharmacist"}</p>
                  <p className="text-xs capitalize text-muted-foreground">{user?.role ?? "pharmacist"}</p>
                </div>
                <div
