...
export const PharmacyLayout = () => {
  ...
  const menuItems = [
    ...
    { name: "Medicines", path: "/pharmacy/medicines", icon: "💊" },
    { name: "Dispensing", path: "/pharmacy/dispensing", icon: "📤" },
    { name: "Inventory", path: "/pharmacy/inventory", icon: "📦" },
    { name: "Low Stock Alerts", path: "/pharmacy/low-stock", icon: "⚠️" },
  ]
